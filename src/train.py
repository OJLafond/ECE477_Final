...
def run_training_scheme(X_train, y_train, X_test, y_test, scheme, save_dir):
    params = {
        'A': {'init_size': 20, 'max_size': 150, 'sparse': True, 'sparse_ratio': 0.3, 'loop_num': 10},
        'B': {'init_size': 100, 'max_size': 150, 'sparse': True, 'sparse_ratio': 0.9, 'loop_num': 10},
        'C': {'init_size': 100, 'max_size': 150, 'sparse': True, 'sparse_ratio': 0.9, 'loop_num': 10}
    }[scheme]
    ...
    model.train(duration=10, folder_to_save=save_dir)
